<template>
  <div class="classHeader">
    ...
    <div class="classHeader-content">
      ...
      <text class="classHeader-content-num" v-if="false" :lines="1">{{hotNum}}人已购买</text>
    </div>
    <div class="classHeader-bottom">
      <text class="classHeader-bottom-price" :lines="1" :style="{color:priceColor}">{{classInfo.price || 0}}MQ</text>
...
export default {
  ...
  computed: {
    ...
    priceColor: function () {
      return this.classInfo.price ? "#E85308" : "rgba(255,255,255,0)"
    }
  },
  methods: {
