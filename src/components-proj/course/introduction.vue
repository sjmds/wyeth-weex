<template>
  <div id = "introduction">
    <text class = "introduction-title" :lines="1" style="-webkit-line-clamp: 1;">{{classInfo.title}}</text>
    <Usercell :userInfo = "userInfo" @clickConcern = "clickConcern"></Usercell>
    <text class = "introduction-title_1" :lines="1" style="-webkit-line-clamp: 1;">简介</text>
    <text class = "introduction-content">{{classInfo.course_desc}}</text>
    <div class = "introduction-tags">
      ...
      <div class = "introduction-tag" v-show = "(classInfo.tags && classInfo.tags.length > 0)" v-for = "(tag, i) in classInfo.tags" :key = "i">
        <text class = "introduction-tag-txt" :lines="1" style="-webkit-line-clamp: 1;" @click = "clickTag(tag)">{{tag.name}}</text>
      </div>
    </div>

    <div class = "introduction-footer">
      <text class = "introduction-footer-text" :lines="1" style="-webkit-line-clamp: 1;">已有{{num2str(classInfo.hot)}}人听过</text>
